...
class TfliteRecognizer {
  ...
  static Map<String, UserModel> registeredFacesMap = {};
  ...
  TfliteRecognizer({int? numThreads}) {
  ...
  UserModel recognize(Image image, Rect location) {
  ...
  findNearest(List<double> emb) {
    ...
    for (MapEntry<String, UserModel> item in registeredFacesMap.entries) {
